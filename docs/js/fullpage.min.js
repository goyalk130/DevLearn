!(function (n, t) {
  ...
  function A(n, t) {
    n = k(n) ? n[0] : n
    for (
      var e = null != t ? p(t, n.parentNode) : n.parentNode.childNodes, i = 0, o = 0;
      o < e.length;
      o++
    ) {
      if (e[o] == n) return i
  ...
  function R(n, t, e) {
    ...
    for (var o = 0; o < n.length; o++) {
      var a = n[o]
      ;((e && !o) || !e) && ((i = t.cloneNode(!0)), a.parentNode.insertBefore(i, a)),
        i.appendChild(a)
    }
    return n
  }
  ...
  var sn = {
      ...
      D: function (n) {
        for (
          var t = this, e = arguments.length, i = new Array(e > 1 ? e - 1 : 0), o = 1;
          o < e;
          o++
        )
          i[o - 1] = arguments[o]
  ...
  var Mt = function (n) {
    ...
    At = function (n, t) {
      ;(this.parent = this.parent || null),
        (this.selector = t),
        (this.anchor = U(n, 'data-anchor') || bt().anchors[A(n, bt().sectionSelector)]),
        (this.item = n),
        (this.isVisible = d(n)),
  ...
  function Rt(n) {
    var t,
      ...
      i = bt()
    return (
      i.autoScrolling && !i.scrollBar ? ((t = -n), (e = p(Nn)[0])) : ((t = n), (e = window)),
      { options: t, element: e }
    )
  }
  function Pt(n, t) {
  ...
  function te(n, t, e) {
    ...
    bt().anchors.length &&
      !bt().lockAnchors &&
      (n
        ? (null != e && (i = e), null == t && (t = n), dn({ _: t }), ee(i + '/' + t))
        : null != n
        ? (dn({ _: t }), ee(e))
        : ee(e)),
      Zt()
  ...
  function se(n, t, e) {
    ...
    ;(c.pn =
      ((i = c.prevSlideIndex), (o = c.slideIndex), i == o ? 'none' : i > o ? 'left' : 'right')),
      ...
      !1 === Yt('onSlideLeave', c)
        ...
        : (L(t, Vn),
          ...
          (function (n) {
            !bt().loopHorizontal &&
              bt().controlArrows &&
              (X(p(st, n.section), 0 !== n.slideIndex), X(p(vt, n.section), null != T(n.destiny)))
          })(c),
          a.isActive && !c.localIsResizing && te(c.slideIndex, c.slideAnchor, c.anchorLink),
          (function (n, t, e) {
            var i,
              o,
              r = t.destinyPos
            if (
              ((i = t.slidesNav),
              (o = t.slideIndex),
              bt().slidesNavigation && null != i && (D(p(Un, i), Vn), L(p('a', p('li', i)[o]), Vn)),
  ...
  function be() {
    ...
    for (var i = '', o = 0; o < hn().C.length; o++) {
      ...
      void 0 !== c &&
        '' !== c &&
        (i += '<div class="fp-tooltip fp-' + bt().navigationPosition + '">' + c + '</div>'),
        (i += '</li>')
    }
    ...
    ;(e = n),
      ...
      (function (n, t) {
        ...
        bt().navigation &&
          ...
          (D(p(Un, e), Vn), L(n ? p('a[href="#' + n + '"]', e) : p('a', p('li', e)[t]), Vn))
      })(n, t)
  }
  ...
  function De(n, t, e) {
    ...
    if (null != i) {
      ...
      if (
        ...
        if (
          (null != u.activeSlide &&
            ((o = U(u.activeSlide, 'data-anchor')), (r = A(u.activeSlide, null))),
          !u.localIsResizing)
        ) {
          var c = u.yMovement
          if (
  ...
  function Ee(n) {
    dn({ B: !1 }),
      (function (n) {
        null != n.mn &&
          (n.isMovementUp ? B(p(Gn)[0], n.mn) : N(p(Gn)[hn().C.length - 1], n.mn),
          It(hn().F.item.offsetTop),
          (function () {
            for (var n = p(Xn), t = 0; t < n.length; t++) he(n[t], 'internal')
          })(),
  ...
  function Ne(n) {
    bt().verticalCentered &&
      ((!bt().scrollOverflow && Ve.yn(n.item)) || Ve.Sn(n) || m(n.item, et) || L(n.item, et))
  }
  ;(f.moveTo = moveTo),
  ...
  function Ie(n) {
    ...
    !hn().F && n.isVisible && (L(t, Vn), qe()),
      ...
      void 0 !== bt().sectionsColor[i] && y(t, { 'background-color': bt().sectionsColor[i] }),
    ...
    Ve = {
      ...
      Mn: function () {
        bt().scrollOverflowMacStyle && !u && L(Vt, 'fp-scroll-mac'),
          hn().vn.forEach(function (n) {
            if (
              !((n.slides && n.slides.length) || (m(n.item, 'fp-auto-height-responsive') && Fe()))
            ) {
              var t,
                e = Dt(n.item),
                i = Ve.yn(n.item),
      ...
      En:
        ...
        function (n) {
          ...
          ;(We = t),
            Y(bt().onScrollOverflow) && Yt('onScrollOverflow', { position: t, direction: e }),
            m(n.target, it) &&
              vn.G &&
              Ve.Pn(e, n.target) &&
              Ve.zn() &&
  ...
  function Ze(n) {
          ...
          (function (n) {
            ...
            N(p(Zn, t)[0], e),
              ...
              '#fff' !== bt().controlArrowColor &&
                ...
                y(p(st, t), {
                  'border-color':
                    'transparent ' + bt().controlArrowColor + ' transparent transparent',
                })),
    ...
    null != l && vn.F && (0 !== vn.F.index() || (0 === vn.F.index() && 0 !== l.index()))
      ? he(l.item, 'internal')
      : L(e[0], Vn)
  }
  ...
  sn.L(yn, function () {
    ...
    bt().observer &&
      ...
      p(Nn)[0] &&
      ((n = p(Nn)[0]), (t = ni), (e = new MutationObserver(ei)).observe(n, t), (Qe = e)),
      sn.L(Tn, ei)
  }),
    (f.render = ei)
  var ii = (function () {
  ...
  function mi() {
    ...
    n || (!bt().loopBottom && !bt().continuousVertical) || (n = hn().C[0]),
      null != n ? De(n, null, !1) : wt().scrollHeight < Vt.scrollHeight && sn.D(Ln)
  }
  function wi() {
    var n = hn().F.prev()
  ...
  function yi(n) {
    bt().autoScrolling &&
      (vn.G && (n.pageY < bi && ce().m.up ? wi() : n.pageY > bi && ce().m.down && mi()),
      (bi = n.pageY))
  }
  function Si(n) {
    if (ce().m[n]) {
  ...
  var Ti,
    ...
    ki = 0,
    Li = 0,
    Di = (o.PointerEvent && (xi = { down: 'pointerdown', move: 'pointermove' }), xi),
    Ei = {
  ...
  function Ri(n) {
    var t = F(n.target, Gn) || hn().F.item,
      e = Ve.Sn(hn().F)
    if (Pi(n)) {
      dn({ X: !0, J: !1 }), bt().autoScrolling && ((e && !vn.G) || bt().scrollBar) && V(n)
      var i = Fi(n)
      ;(ki = i.y), (Li = i.x)
    ...
    9 === e
      ? (function (n) {
          ...
          if (
            ...
            e
              ? null == F(e, '.fp-section.active,.fp-section.active .fp-slide.active') && (e = o(n))
              : o(n)
            var a = e == i[0],
              u = e == i[i.length - 1],
              c = t && a
            if (c || (!t && u)) {
              ...
              var l = (function (n) {
                  ...
                  do {
                    ;(i = Ji(o.item)).length && (t = { Vn: o, Un: i[n ? i.length - 1 : 0] }),
                      (o = Et(o[e]()))
                  } while (o && 0 === i.length)
                  return t
                })(c),
              ...
              if (f) {
                ...
                sn.D(An, { _n: s.index() + 1, slideAnchor: f.un ? 0 : f.index() }),
                  (Ai = l.Un),
                  V(n)
              }
            }
  ...
  function to(n) {
    n
      ...
      : (r.addEventListener
          ? (G('mousewheel', eo, !1), G('wheel', eo, !1), G('MozMousePixelScroll', eo, !1))
  ...
  function eo(n) {
        ...
        if (hn().B) {
          if (e) {
            ...
            if (!(i || (gi('isNewKeyframe', 'beyondFullpage') && li.Nn())))
              return (
                (o = Rt(rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight)).element.scrollTo(
                  0,
                  o.options,
                ),
                dn({ In: !1 }),
            ...
            if (li.Nn()) return (e = !1), dn({ In: !0 }), dn({ N: 'wheel' }), vi(), V(t), !1
          } else gi('set', 'beyondFullpage', 1e3)
          if (!i && !e) return !0
        }
      })(wt(), n)
    if ((vn.J || dn({ X: !1, J: !0, K: 'none' }), !ce().m.down && !ce().m.up)) return V(n), !1
    if (i) return !0
    if (!1 === i) return V(n), !1
    if (bt().autoScrolling && !Ti && !e) {
      ...
      return (
        ...
        f > 200 && (no = []),
        dn({ Y: l }),
        vn.G && an(no, 10) >= an(no, 70) && c && (dn({ N: 'wheel' }), Si(a < 0 ? 'down' : 'up')),
        !1
      )
    }
        ...
        (function () {
          if (Ei.Hn && (a || c)) {
            bt().autoScrolling &&
              ...
              Vt.removeEventListener(Ei.Hn, Ni, { passive: !1 }))
            var n = bt().touchWrapper
            n.removeEventListener(Ei.Wn, zi), n.removeEventListener(Ei.Hn, Ri, { passive: !1 })
          }
        })())
  }
      ...
      (so = setTimeout(function () {
        !(function () {
          if (
            ...
            (e = w()), (i = b()), (vn.tn === e && po === i) || (dn({ tn: e }), (po = i), bo(!0))
          var e, i
          dn({ W: !1 })
        })(),
          (go = !1)
  ...
  function bo(n) {
    if (!m(wt(), Hn)) {
      ...
      vn.B || (a && fo(a + 1)),
        dn({ W: !1 }),
        Y(bt().afterResize) && n && bt().afterResize.call(wt(), o.innerWidth, o.innerHeight),
  ...
  function Do(n) {
    ...
    if (
      !vn.W &&
      hn().F &&
      (rn(hn().C), !hn().B && !hn().In && (!bt().autoScrolling || bt().scrollBar))
    ) {
      var a = H(),
        u = (function (n) {
          var t = n > Lo ? 'down' : 'up'
      ...
      else if (a) for (var v = 0; v < s.length; ++v) s[v].item.offsetTop <= l && (c = v)
      else c = 0
      if (
        ((i = u),
  ...
  function Bo(n, t) {
    var e
    if (((Vt = p('body')[0]), (Ut = p('html')[0]), (_t = p('html, body')), !m(Ut, Wn)))
      return (
        'touchWrapper',
  ...
  return (
      ...
      sn.L(bn, function () {
        ...
        dn({
          Kn:
            ...
            ((u || c) &&
              ((bt().credits && u && e <= u.$n && u.Xn === t.split(n[0])[4]) || c || u.Qn)) ||
              !1),
        })
      })
      var n = ['-'],
    ...
    (f.destroy = function (n) {
      ge(!1, 'internal'),
        ...
        n &&
          (It(0),
          p('img[data-src], source[data-src], audio[data-src], iframe[data-src]', wt()).forEach(
            function (n) {
              un(n, 'src')
            },
          ),
          ...
          y(wt(), { height: '', position: '', '-ms-touch-action': '', 'touch-action': '' }),
          ...
          xt(hn().vn).forEach(function (n) {
            bt().scrollOverflow && Ve.Rn(n),
              ...
              U(n, 'data-fp-styles') && n.setAttribute('style', U(n, 'data-fp-styles')),
